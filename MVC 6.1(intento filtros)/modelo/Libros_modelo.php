...
class Libros_modelo {
    static public function get_libros_modelo($pTitulo, $pOrderBy) {             
        try {
            $consulta = Conectar::conexion()->prepare("CALL librosXtitulo(:pTitulo, :pOrderBy)");

            $consulta->bindParam(":pTitulo", $pTitulo, PDO::PARAM_STR);
            $consulta->bindParam(":pOrderBy", $pOrderBy, PDO::PARAM_STR);
